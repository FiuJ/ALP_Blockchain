    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800">
      ...
      <header className="px-8 py-20 text-center flex flex-col items-center bg-gradient-to-b from-blue-50 to-gray-50">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 leading-tight max-w-4xl mb-6">
          Lindungi Integritas <span className="text-blue-600">Surat Medis</span> dengan Teknologi Blockchain
        </h1>
        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mb-10">
          Penerbitan surat keterangan sakit digital yang anti-pemalsuan. Diverifikasi secara kriptografis melalui jaringan Ethereum untuk rumah sakit, pasien, dan HRD perusahaan.
        </p>
      ...
      <section id="fitur" className="py-20 px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600">Menggabungkan kemudahan Web2 dengan keamanan Web3</p>
        </div>
      ...
      <section id="cara-kerja" className="bg-white py-20 px-8">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-12">Alur Verifikasi dalam 3 Langkah</h2>
          <div className="flex flex-col md:flex-row justify-center items-start gap-10">
            <StepCard number="1" title="Dokter Terverifikasi" desc="Dokter mendaftar dan SIP diverifikasi oleh Admin. Setelah valid, dokter dapat mengunggah dan menandatangani surat medis pasien." />
            <StepCard number="2" title="Pencatatan Blockchain" desc="Sistem menghasilkan Hash unik dari PDF surat dan mencatatnya ke Smart Contract. Dokumen asli disimpan di server." />
            <StepCard number="3" title="Validasi Pihak Ketiga" desc="HRD atau instansi cukup memasukkan ID Dokumen. Sistem akan mencocokkan Hash dengan data di Blockchain secara instan." />
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 px-8 text-center">
        ...
        <p className="mb-6">Sistem Verifikasi Surat Dokter Digital Terdesentralisasi.</p>
        <div className="text-sm">
          &copy; {new Date().getFullYear()} Tim Pengembang Web3. All rights reserved.
        </div>
      </footer>
    </div>
  );
...
const StepCard: React.FC<StepCardProps> = ({ number, title, desc }) => (
  <div className="flex-1 text-left relative">
    <div className="text-5xl font-black text-blue-100 absolute -top-6 -left-4 z-0">{number}</div>
